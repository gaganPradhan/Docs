<?php
	...
	if(isset($_GET["view"])){
		...
		$id 		= $_GET["view"];
		$selectnews	= "SELECT * FROM news WHERE Id='$id'";
		...
		if(isset($_SESSION["username"])){
			...
			$selectuser = "SELECT Id FROM users WHERE Username='$username'";
  	...
  	<?php
  		if(isset($_SESSION["username"])){
		    ...
		    <td>
		    		...
		    		<form class="form-inline my-2 my-lg-0" action = "news_process.php" method = "get">

                         <button class="btn btn-outline-success my-2 my-sm-0" type="submit" name="delete" value="<?php echo $newsid;?>">Delete</button>
					</form>
		    		<form class="form-inline my-2 my-lg-0" action = "update_news.php" method = "get">
                        <button class="btn btn-outline-success my-2 my-sm-0" type="submit" name="update" value="<?php echo $newsid;?>">Update</button>
