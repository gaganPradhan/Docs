...
class User {
	...
	{
		$sql = "SELECT *, requests.id as request_id FROM ((users INNER JOIN requests ON users.id = requests.user_id) INNER JOIN departments ON users.dpt_id = departments.id)";
	...
	public function updateRequest($fields = [], $id = null)
	{
